...
from investigate_transfer_cost import parse_gold_excel
...
def main() -> int:
    ...
    project_root = output_dir.resolve().parents[3]  # weekly->transfers->c_processed->data->root
